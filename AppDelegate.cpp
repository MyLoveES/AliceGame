...
static cocos2d::Size microResolutionSize = cocos2d::Size(360, 640);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("Alicegame", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
		glview->setFrameSize(360,640);
#else
        glview = GLViewImpl::create("Alicegame");
#endif
    ...
    //{        
    //    director->setContentScaleFactor(MIN(designResolutionSize.height / largeResolutionSize.height, largeResolutionSize.width/designResolutionSize.width));
    //}
